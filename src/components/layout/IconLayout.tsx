...
import MeLogoDark from '../../assets/LOGO01.png'
import MeLogoGlow from '../../assets/LOGO02.png'
...
const IconLayout: React.FC = () => {
    ...
    useEffect(() => {
        ...
        if (spanRef.current) {
            (spanRef.current as HTMLSpanElement).style.display = currentUrl.includes('http://localhost:5174/craftzwolf') ? 'block' : 'none';
        }
